...
namespace Tests
{
    ...
    public class CarTests
    {
        ...
        public void AllProperiesShouldThrowArgumentExceptionForInvalidValues(string make, string model, double fuelConsumption, double fuelCapacity)
        {
            Assert.Throws<ArgumentException>(() => new Car(make, model, fuelConsumption, fuelCapacity));
        }
        ...
        [Test]
        public void ShouldRefuelNormallyOverCapacity()
        {
            string make = "VW";
            string model = "Golf";
            double fuelConsumption = 2;
        ...
        [TestCase(-10)]
        [TestCase(0)]
        public void RefuelShouldThrowArgumentExceptionWhenInputBelowZero(double inputAmount)
        {
            string make = "VW";
            string model = "Golf";
            double fuelConsumption = 2;
