...
namespace P03_FootballBetting.Data.Migrations
{
    public partial class InitialSetUp : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TeamId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 50, nullable: false),
                    LogoUrl = table.Column<string>(unicode: false, maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerStatistics_PlayerStatistics_PlayerStatisticPlayerId_PlayerStatisticGameId",
                        columns: x => new { x.PlayerStatisticPlayerId, x.PlayerStatisticGameId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerStatistics_PlayerStatisticPlayerId_PlayerStatisticGameId",
                table: "PlayerStatistics",
                columns: new[] { "PlayerStatisticPlayerId", "PlayerStatisticGameId" });
